...
int main(void)
{
   ...
   RUN_TEST(test_basic_abbreviation); // OK
   RUN_TEST(test_null_string); // OK
   RUN_TEST(test_lower_case_words); // OK
   RUN_TEST(test_punctuation); // OK
   RUN_TEST(test_non_acronym_all_caps_words); // OK
   RUN_TEST(test_hyphenated); // OK
   RUN_TEST(test_all_caps_words); // OK
